...
import cz.cvut.fel.integracniportal.service.AbstractNodeService
...
/**
 * Test for {@link AclController#updateNodeAcl(java.lang.String, java.util.List)}
 *
 * @author Eldar Iosip
 */
...
@Transactional
public class AclController_updateNodeAcl_Test extends AbstractIntegrationTestCase {
    ...
    @Test
    void "should add read permission to a folder for one user"() {
