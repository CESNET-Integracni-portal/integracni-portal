...
@Transactional
public class SpaceController_uploadFile_Test extends AbstractIntegrationTestCase {
    ...
    void "should upload a file and return meta data"() {
        mockMvc.perform(fileUpload(fromApi("space/cesnet/file")).file(createFile()))
    ...
    void "should return 404 error for non-existing space"() {
        mockMvc.perform(fileUpload(fromApi("space/xxx/file")).file(createFile()))
